<template>
  <div class="page">
      <div class="top">
        <div class="Dheader">
            <img src="https://img3.doubanio.com/f/freyr/1bcc965d4d72b118225b509bcf2396b716b324d3/pics/icon/logo_black.png" alt="">
        </div>
        <div class="banner"></div>
        <div class="text">
            <p>立体书领域有一项荣誉大奖，叫“梅根多夫大奖”，堪比电影界的“奥斯卡”，美国纸艺大师马修·莱茵哈特就曾两度上榜。</p>
            <p>马修的作品有很多曾被国内出版社引进过，《世界经典立体书珍藏版：灰姑娘》《3D变形金刚》《星球大战：银河系立体书》《超级英雄立体书》等。他的作品把立体书推向一个崭新高度，令全世界的读者耳目一新，不光受到孩子们的疯狂喜爱，很多成年人也争相收藏。</p>
            <p>在马修的众多作品中，《哈利·波特立体书：霍格沃茨魔法学校》受到全球哈利·波特粉丝的瞩目，成为经典中的经典。他说，“到目前为止，这是我做过的最为复杂的立体书之一。”</p>
        </div>
    </div>
    <!-- main -->
    <div class="main">
...
<script>
import {DostoevskyApi} from "@api/books"
export default {
...
.banner{
    width: 100%;
    height: 2.333rem;
    background: url(https://img3.doubanio.com/view/freyr_page_photo/raw/public/4785.jpg) no-repeat;
...
.main .nav span{
    ...
    width: .517rem;
    height: .467rem;
    border-bottom: 2px solid #e76648;
}
.main .comment{
    width: 100%;
    box-sizing: border-box;
