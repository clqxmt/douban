  ...
  <div class="page">
    ...
    <div>
      <div class="detail">
        <div class="book_info">
          <div class="book_logo">
            <img src="https://img3.doubanio.com/view/subject/m/public/s33296515.jpg" alt />
          </div>
          <div class="introduce">
            <h2>大脑健身房</h2>
            <div class="rank">
              <span>No.5</span>
              <span>一周热门非虚构类图书</span>
            </div>
            <p>后浪丨中国友谊出版公司 / 2019-9出版</p>
            <div class="choose">
              <span>
                <i></i>
                想读
        ...
        <div class="score">
          ...
          <div class="starandline">
            <div class="starline_5">
              <div class="star_5">
                <span class="star_none" style="width: 7px; height: 7px;"></span>
                <span class="star_none" style="width: 7px; height: 7px;"></span>
                <span class="star_none" style="width: 7px; height: 7px;"></span>
                <span class="star_none" style="width: 7px; height: 7px;"></span>
                <span class="star_none" style="width: 7px; height: 7px;"></span>
      ...
      <div class="introduction">
        ...
        <i>
          ...
          <br />Spotify联合创始人与国际奥委会医学委员会委员倾情推荐，12种语言版本热销全球，仅瑞典一国售出27万册
        </i>
        <div></div>
      </div>
      ...
      <div class="comment">
        ...
        <ul>
          <li>
            <div class="user_logo">
              <img src="https://img3.doubanio.com/icon/up1103455-23.jpg" alt />
              <div class="username">Jayce</div>
              <span class="star"></span>
              <span class="star"></span>
              <span class="star"></span>
              <span class="star"></span>
              <span class="star"></span>
              <span class="user_time">4个月前</span>
            </div>
            <div class="user_comment">
              <p>看完这本书，立刻翻出运动衣，出门跑步，是时候要展开一场保卫海马体，控制杏仁核的运动了！</p>
              <div class="user_info">
