...
/**活动 */
Mock.mock(/\/bookstore\/activity/,"get",(options)=>{
  var obj={
    code:200,
    errMeg:"",
    data:{
...
/**新书 */
Mock.mock(/\/bookstore\/newbook/,"get",(options)=>{
  var obj={
    code:200,
    errMeg:"",
    data:{
...
/**书单 */
Mock.mock(/\/bookstore\/topic/,"get",(options)=>{
  var obj={
    code:200,
    errMeg:"",
    data:{
...
/**新书的详细信息 */
Mock.mock(/\/bookstore\/newbookDetail/, "get",(options)=>{
  ...
  for(var i=0;i<newbookDetail.data.length;i++){
    
    if(newbookDetail.data[i].id===id){
        obj.data.list.push(topicData.data[i]);
    }
